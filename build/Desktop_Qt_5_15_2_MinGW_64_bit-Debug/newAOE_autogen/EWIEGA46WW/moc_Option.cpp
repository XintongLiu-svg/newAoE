...
void Option::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Option::changeMusic)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Option::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Option::request_ClearDebugText)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Option::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Option::request_exportHtml)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Option::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Option::request_exportTxt)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Option::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Option::request_exportClear)) {
                *result = 4;
                return;
            }
        }
